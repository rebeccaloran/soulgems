...
## There are abilities that may be used during main phases.
	...
	any of your pieces are directly adjactent one space in any direction around an opponent's.
	...
	Roll **(2)** **10-sided dies** to determine percentage, the first denoting the two left digits and the second denoting the 1
	
	**If the first die die is a 10, you automatically succeed in performing the Soul Steal 
	
	The Soul Steal will be succesful if you roll any number up to and including **[20(pieces adhacent)]**t with a max of **(4)** pieces 
...
### The King is a direct link to the Soul Guardian, a God. 
	...
	**Roll **(2)** **10-sided dice** 
	...
	A **(10)** counting as a roll of **(100)**
	
	You need to have a result higher than **[10(number of pieces adjacent)]** with a max of **(8)**
